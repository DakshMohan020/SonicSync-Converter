...
export default function ApiHubPage() {
  ...
  "file": {
    ...
    "download_url": "https://storage.sonicsync.io/files/cf78a3d1.mp3"
  }
}`;
  ...
  return (
    <main className="min-h-[calc(100vh-73px)] max-w-5xl mx-auto p-8 space-y-8">
      <div className="border-b border-outlineVariant/20 pb-4">
        ...
        <p className="text-xs text-mutedText mt-0.5">Use the SonicSync API to convert YouTube videos to MP3 directly from your own app or script.</p>
      </div>
        ...
        <div className="lg:col-span-2 space-y-5">
          <div className="bg-surface-containerLowest/40 backdrop-blur-glass border border-outlineVariant/20 rounded-lg p-6 space-y-4">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-sm font-semibold text-onSurface">API Endpoint</h2>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3 font-mono text-[11px] bg-surface-containerLowest p-2.5 rounded border border-outlineVariant/20">
                ...
                <span className="text-onSurfaceVariant font-medium">https://api.sonicsync.io/v1/convert</span>
              </div>
              <p className="text-xs text-mutedText leading-relaxed">
                Send a YouTube URL in the request body. The API will convert it to MP3 and return a download link along with the song title, artist, and cover art.
              </p>
            </div>

            <div className="space-y-2 pt-2 border-t border-outlineVariant/10">
              <div className="text-[11px] font-mono text-mutedText">Required Headers:</div>
              <div className="font-mono text-[11px] bg-surface-containerLow p-3 rounded text-onSurfaceVariant/80 space-y-1 border border-outlineVariant/10">
                <div>Authorization: <span className="text-primary">Bearer YOUR_API_KEY</span></div>
          ...
          <div className="bg-surface-containerLowest/40 backdrop-blur-glass border border-outlineVariant/20 rounded-lg p-6 space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-semibold text-onSurface">Your API Key</h3>
              </div>
              <button
              ...
              >
                {apiKeyGenerated ? 'Generate New Key' : 'Generate API Key'}
              </button>
            </div>
            {apiKeyGenerated ? (
              ...
              <p className="text-xs text-mutedText">You don't have an API key yet. Click the button above to generate one.</p>
            )}
          </div>
        </div>
