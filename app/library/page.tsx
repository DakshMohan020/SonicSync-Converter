  ...
  return (
    <main className="min-h-[calc(100vh-73px)] max-w-5xl mx-auto p-8 space-y-6">
      <div className="border-b border-outlineVariant/20 pb-4">
        <h1 className="text-xl font-semibold text-onSurface tracking-tight">This Session</h1>
        <p className="text-xs text-mutedText mt-0.5">Songs you converted during this browser session. This list clears when you close the tab.</p>
      </div>
      ...
      {sessionDownloads.length === 0 ? (
        <div className="bg-surface-containerLowest/30 backdrop-blur-glass border border-outlineVariant/20 rounded-lg p-12 text-center space-y-3">
          ...
          <p className="text-xs text-mutedText">You haven't converted anything yet.</p>
          ...
          {sessionDownloads.map((asset) => (
            ...
            >
              <div className="flex items-center space-x-4 min-w-0">
                <img src={asset.coverUrl} alt="Thumbnail" className="w-11 h-11 rounded object-cover border border-outlineVariant/20 shrink-0" />
